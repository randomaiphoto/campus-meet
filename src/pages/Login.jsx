      ...
      <div className="relative z-10 flex flex-col md:flex-row shadow-2xl rounded-3xl overflow-hidden max-w-5xl w-11/12 md:w-3/4 lg:w-2/3 bg-white/10 backdrop-blur-lg border border-white/20">
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-indigo-700 to-violet-800 p-10 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 text-white">
            ...
            <p className="text-lg text-white/80 mb-8">Your complete campus experience management platform</p>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-sm">Access to university events & workshops</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 p-1 rounded-full mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span className="text-sm">Personalized dashboard for your role</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 p-1 rounded-full mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span className="text-sm">Quick notifications of important updates</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-10 md:p-12 flex flex-col justify-center">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 text-sm">Sign in with your university account</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-white/60 text-sm">Don't have an account? 
              <a href="/register" className="ml-1 text-white hover:text-indigo-200 transition-colors">
                Register here
              </a>
            </p>
          </div>
